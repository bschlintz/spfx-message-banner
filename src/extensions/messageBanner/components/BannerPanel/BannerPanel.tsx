...
class BannerPanel extends React.Component<IBannerPanelProps, {}> {
        ...
        <div className={styles.FieldContainer}>
          <div className={styles.FieldSection}>
            ...
            <TextField
              ...
              onChanged={(value) => props.onFieldChange({ message: value })}
            />
          </div>
          ...
          <div className={styles.FieldSection}>
            ...
            />
            <TextField
              defaultValue={props.settings.textColor}
              onChanged={(value) => props.onFieldChange({ textColor: value })}
            />
          </div>
          ...
          <div className={styles.FieldSection}>
            ...
            />
            <TextField
              defaultValue={props.settings.backgroundColor}
              onChanged={(value) => props.onFieldChange({ backgroundColor: value })}
            />
          </div>
          ...
          <div className={styles.FieldSection}>
            ...
            <Toggle
              ...
              onChanged={(value) => props.onFieldChange({ visibleStartDate: value ? new Date() : null })}
            />
